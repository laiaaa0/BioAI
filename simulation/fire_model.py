...
class FireModel():
    ...
    # the fire burning out from the middle)? Don't really want to consider
    # every square every time.
    def update(self):
        # Testing
        ...
        # TODO A little disorientated about which way is width and which is
        # height!
